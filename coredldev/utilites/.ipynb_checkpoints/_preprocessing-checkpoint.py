...
def cut_at_lowest_envelope(hplus, hcross, getcross=False):
    ...
    if not getcross:
        ...
        return mhplus[envcut[0][0] :], hcross[envcut[0][0] :]
...
window = lambda ts: planck_window(math.floor(math.log(len(ts) / 2) * 6), len(ts))
